...
alex = {first_name: "Alex", last_name: "Jones", location_id: add_location("North Providence", "Rhode Island"), email: "Akjones2007@gmail.com", password_digest: "password"}
amy = {first_name: "Amy", last_name: "Macomber", location_id: add_location("North Providence", "Rhode Island"), email: "amacomber@gmail.com", password_digest: "password"}
drew = {first_name: "Drew", last_name: "McMullen", location_id: add_location("Newton", "Massachusetts"), email: "drew@gmail.com", password_digest: "password"}
meng = {first_name: "Meng", location_id: add_location("Brookline", "Massachusetts"), email: "meng@gmail.com", password_digest: "password"}
jenn = {first_name: "Jenn", last_name: "Rich", location_id: add_location("Warren", "Maine"), email: "jenn@gmail.com", password_digest: "password"}

[alex, amy, drew, meng, jenn].each do|hash|
  User.create!(hash)
end
